...
(function startAirportSimulation() {
    ...
    let planes = [
        ...
        new MilitaryPlane('B-1B Lancer', 1050, 21000, 80000, MilitaryType.TYPEFIGHTER),
        new MilitaryPlane('B-2 Spirit', 1030, 22000, 70000, MilitaryType.TYPEFIGHTER),
        new MilitaryPlane('B-52 Stratofortress', 1000, 20000, 80000, MilitaryType.TYPEFIGHTER),
